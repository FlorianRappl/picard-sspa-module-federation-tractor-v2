      ...
      <main className="d_ProductPage">
        <div className="d_ProductPage__details">
          ...
          <div className="d_ProductPage__productInformation">
            ...
            <pi-slot name="AddToCart" data={JSON.stringify({ sku: variant.sku })} />
          </div>
        </div>
        <pi-slot name="Recommendations" data={JSON.stringify({ skus: [variant.sku] })} />
      </main>
      <pi-slot name="Footer" />
    </div>
  );
...
export default singleSpaReact({
  ...
  errorBoundary() {
    return <div>ProductPage failed!</div>;
  },
});
